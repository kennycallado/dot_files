...
## Script arguments
FILE_PATH="${2}"         # Full path of the highlighted file
PV_WIDTH="${4}"          # Width of the preview pane (number of fitting characters)
## shellcheck disable=SC2034 # PV_HEIGHT is provided for convenience and unused
PV_HEIGHT="${6}"         # Height of the preview pane (number of fitting characters)
	...
	message/rfc822)
        ...
        *ms-excel)
        ...
        text/* | */xml)
            ...
            env COLORTERM=8bit cat --style="plain" \
